...
class EmailInput extends React.Component {
  ...
  render() {
    ...
    var groupStyle ='form-group';
    if(!errors.isValid) {
      inputStyle += ' alert-danger';
      groupStyle += ' has-error';
    }

    return (
      <div className={groupStyle}>
        <label htmlFor="email">Email</label>
        <input type="email" id="email" name="email" className={inputStyle} placeholder="email address"
...
class RequiredInput extends React.Component {
  validate(currentValue){
    ...
    return {required: false, isValid: true}; //no errors
  }  
  ...
  render() {
    ...
    return (
      <div className={groupStyle}>
        ...
        <input type={this.props.type} id={this.props.id} name={this.props.field} className={inputStyle} placeholder={this.props.placeholder}
                value={this.props.value}
                onChange={(e) => this.handleChange(e)}
        />
        {errors.required &&
  ...
  render() {
    ...
    return (
      <div className={groupStyle}>
        ...
        <input type="password" id="passwordConf" name="passwordConf" placeholder="your secret password again" className={inputStyle}
                 value={this.props.value}
                onChange={(e) => this.handleChange(e)}
        />
        {errors.mismatched &&
